...
class Fun_Commands(commands.Cog):
    ...
    async def noticeme(self, ctx: Context[BotT]):
        ...
        bio = BytesIO(await http.get("https://media.discordapp.net/attachments/822271819712561152/940251046725439588/sus-2.gif", res_method="read"))
    ...
    @commands.command(aliases=['colors' , 'colour'])
